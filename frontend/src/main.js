...
const { handleSavePath } = require(path.join(__dirname, "actions", "dialogs"))
const { handleDisplaySources } = require(path.join(__dirname, "actions", "displaySources"))
const { createFolder, clearFolder } = require(path.join(__dirname, "actions", "utilityFunctions"))
...
app.on("ready", () => createFolder(path.join(__dirname, "..", "..", "backend", "temp")))
// Create Recordings folder if folder unavailable
app.on("ready", () => createFolder(path.join(__dirname, "..", "..", "Recordings")))
...
ipcMain.handle(WINDOW_CLOSE, handleWindowClose = (e) => {
  clearFolder(path.join(__dirname, "..", "..", "backend", "temp"))
  mainWindow.close()
})
